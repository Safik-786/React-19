...
export default function VintagePastelHomepage() {
  const [mobileMenuOpen, setMobileMenuOpen] = useState(false);

  return (
    <div className="min-h-screen" style={{ backgroundColor: '#F5F5F7' }}>
      {/* Navigation */}
      <nav className="sticky top-0 shadow z-50" style={{ backgroundColor: '#EDDFE0' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex-shrink-0">
              <h1 className="text-2xl font-bold" style={{ color: '#705C53' }}>
                Maison
              </h1>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-4">
              <button className="p-2 rounded-full hover:bg-white/30 transition-all">
                <Heart size={20} style={{ color: '#705C53' }} />
              </button>
              <button className="p-2 rounded-full hover:bg-white/30 transition-all">
                <ShoppingBag size={20} style={{ color: '#705C53' }} />
              </button>
            </div>
            ...
            <div className="md:hidden">
              ...
              >
                {mobileMenuOpen ? (
                  <X size={24} style={{ color: '#705C53' }} />
                ) : (
                  <Menu size={24} style={{ color: '#705C53' }} />
                )}
              </button>
            </div>
          </div>
        ...
        {/* Mobile Menu */}
        {mobileMenuOpen && (
          <div className="md:hidden" style={{ backgroundColor: '#EDDFE0' }}>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <button
                className="group px-8 py-4 rounded-full flex items-center space-x-2 hover:shadow-lg transition-all duration-300"
            ...
            <div className="relative">
              <div
                className="aspect-square rounded-3xl shadow"
                style={{ backgroundColor: '#EDDFE0' }}
              >
                <div className="absolute inset-0 flex items-center justify-center">
                  <Star size={120} style={{ color: '#B7B7B7', opacity: 0.3 }} />
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: '#705C53' }}>
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
            ...
            />
            <button
              className="px-8 py-4 rounded-full hover:shadow-lg transition-all"
      ...
      {/* Footer */}
      <footer className="py-12 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: '#EDDFE0' }}>
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <h4 className="text-xl font-bold mb-4" style={{ color: '#705C53' }}>
                Maison
              </h4>
            ...
            <div>
              <h5 className="font-semibold mb-3" style={{ color: '#705C53' }}>Shop</h5>
            ...
            <div>
              <h5 className="font-semibold mb-3" style={{ color: '#705C53' }}>About</h5>
              <ul className="space-y-2" style={{ color: '#B7B7B7' }}>
            ...
            <div>
              <h5 className="font-semibold mb-3" style={{ color: '#705C53' }}>Follow Us</h5>
              <div className="flex space-x-4">
                <Instagram className="cursor-pointer hover:opacity-70 transition-opacity" style={{ color: '#705C53' }} />
                <Facebook className="cursor-pointer hover:opacity-70 transition-opacity" style={{ color: '#705C53' }} />
                <Twitter className="cursor-pointer hover:opacity-70 transition-opacity" style={{ color: '#705C53' }} />
              </div>
            </div>
          </div>
